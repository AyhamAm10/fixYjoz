...
const SellingState: React.FC = () => {
  ...
  const handleToggle = (): void => {
    ...
    dispatch(setFormData({is_selling_support : !isConfirmed}))
  };

//   useEffect(()=>{
//     dispatch(setFormData({is_renting_support : isConfirmed}))
